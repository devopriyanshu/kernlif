        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-200 max-w-xs">
              Your all-in-one platform for mental and physical wellness, helping
              you achieve balance and health through personalized guidance.
            </p>
          ...
          <div>
            ...
            <p className="text-blue-200 mb-4">
              Subscribe to our newsletter for wellness tips, updates, and
              exclusive offers.
            </p>
            <form className="space-y-2">
              <div className="flex flex-col space-y-2">
                <input
                  ...
                  className="px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-800"
                  required
                />
                <button
                  type="submit"
